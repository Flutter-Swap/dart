    ...
    if (b == null) {
      ...
      if (a == null) {
        ...
        return RRect._raw(
          ...
          tlRadiusX: math.max(0, lerpDouble(a.tlRadiusX, b.tlRadiusX, t)),
          tlRadiusY: math.max(0, lerpDouble(a.tlRadiusY, b.tlRadiusY, t)),
          trRadiusX: math.max(0, lerpDouble(a.trRadiusX, b.trRadiusX, t)),
          trRadiusY: math.max(0, lerpDouble(a.trRadiusY, b.trRadiusY, t)),
          brRadiusX: math.max(0, lerpDouble(a.brRadiusX, b.brRadiusX, t)),
          brRadiusY: math.max(0, lerpDouble(a.brRadiusY, b.brRadiusY, t)),
          blRadiusX: math.max(0, lerpDouble(a.blRadiusX, b.blRadiusX, t)),
          blRadiusY: math.max(0, lerpDouble(a.blRadiusY, b.blRadiusY, t)),
        );
      }
    }
  }
