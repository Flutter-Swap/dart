...
import 'package:swap/src/utils/string.dart';
import 'package:swap/src/basic_types/geometry.dart';
    ...
    assert(() {
      for (int index = 0; index < controlPoints.length; index++) {
        if (!controlPoints[index].isFinite) {
          throw ('The provided CatmullRomSpline control point at index $index is not '
